// echo 1 > /peek/peekfs/conf/allow_overflow # to allow buffer overflows
// printf "ovrflow0newmessg" > /peek/peter5/target/.raw # to overwrite the contents of "message" and its terminating NULL byte in order to reveal "secret"
// cat /dev/peter5 # to reveal secret
